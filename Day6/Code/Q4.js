...
console.log(`Decimal: 4095, Hex: ${convertToHex(4095)}`); 
console.log(`Decimal: 1093, Hex: ${convertToHex(1093)}`); 
console.log(`Decimal: 16, Hex: ${convertToHex(16)}`);    
console.log(`Decimal: 215, Hex: ${convertToHex(215)}`);     
